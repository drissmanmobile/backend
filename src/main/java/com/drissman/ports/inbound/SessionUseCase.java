...
public interface SessionUseCase {
    Mono<Session> scheduleSession(UUID schoolId, UUID enrollmentId, UUID offerId, UUID monitorId, UUID moduleId, UUID lessonId, LocalDate date, LocalTime startTime, LocalTime endTime, String meetingPoint);
